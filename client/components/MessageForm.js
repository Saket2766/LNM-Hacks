...
const MessageForm =()=>{
    ...
    return <form className={styles.chatInputContainer}>
        <div className ={styles.chatInputWrapper}>
            ...
            <input type ='text'className= {styles.chatInput} value ={messageText} disabled ={currentAccount.name} onChange ={e => setMessageText(e.target.value)} placeholder ={placeholder} />
